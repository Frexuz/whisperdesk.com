# S-Tier SaaS Design Checklist (Inspired by Stripe, Airbnb, Linear)
...
*   [ ] **Consistency:** Maintain a uniform design language (colors, typography, components, patterns) across the entire webapp.
...
*   [ ] **Develop Core UI Components (with consistent states: default, hover, active, focus, disabled):**
    ...
    *   [ ] Toggles/Switches
    *   [ ] Cards (for content blocks, multimedia items, webapp widgets)
...
*   [ ] **Purposeful Micro-interactions:** Use subtle animations and visual feedback for user actions (hovers, clicks, form submissions, status changes).
    ...
    *   [ ] Animations should be quick (150-200ms) and use appropriate easing (e.g., ease-in-out).
...
*   [ ] **Responsive Design:** Ensure the webapp is fully functional and looks great on all device sizes (desktop, tablet, mobile).
